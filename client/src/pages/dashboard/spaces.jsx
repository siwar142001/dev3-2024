...
export default function Spaces() {
    ...
    const fetchData = async () => {
      const response = await axios.get("http://localhost:5000/spaces/allSpaces");
        
      setRows(response.data.spaces);
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      id="outlined-basic" label="Titre" variant="outlined" />
        <TableContainer>
          <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle" size={dense ? 'small' : 'medium'}>
            ...
            <TableBody>
              ...
              .filter(row => {
                ...
                if (id !== "" && titre !== "") {
                  // Filter rows based on id and titre
                  return row.id === id && row.titre.toLowerCase().includes(titre.toLowerCase());
                } else if (id !== "") {
